      ...
      <div className="bg-[#fffdfd] rounded-lg shadow-lg py-5 px-28 flex flex-col items-center justify-center my-8">
         ...
         <table className="table-fixed w-max">
            <tbody className={`${roboto.className} text-center`}>
               <tr>
                  <td className="text-2xl px-4 py-2 uppercase font-bold">Clay</td>
                  <td className="text-2xl px-4 py-2 uppercase font-bold">91</td>
               </tr>
               <tr>
                  <td className="text-2xl px-4 py-2 uppercase font-bold">Ryan</td>
                  <td className="text-2xl px-4 py-2 uppercase font-bold">78</td>
               </tr>
            </tbody>
         </table>
      </div>
