...
internal sealed class ProcessOutboxJob(
    ...
    IIntegrationsDomainEventDispatcher domainEventDispatcher) : IJob
{
  ...
  private readonly IIntegrationsDomainEventDispatcher _domainEventDispatcher = domainEventDispatcher;
      ...
      IDbTransaction transaction)
  {
    var sql =
        $"""
             ...
             FROM integrations.outbox_messages
      ...
      Exception? exception)
  {
    const string sql =
        """
            UPDATE integrations.outbox_messages
