...
using ScreenDrafts.Modules.Integrations.Infrastructure.Database;

#nullable disable

namespace ScreenDrafts.Modules.Integrations.Infrastructure.Database.Migrations
{
    [DbContext(typeof(IntegrationsDbContext))]
    [Migration("20250203035420_Add_InboxAndOutbox")]
            ...
            modelBuilder.Entity("ScreenDrafts.Common.Infrastructure.Inbox.InboxMessageConsumer", b =>
                {
                    ...
                    b.ToTable("inbox_message_consumers", "integrations");
                });
            ...
            modelBuilder.Entity("ScreenDrafts.Common.Infrastructure.Outbox.OutboxMessageConsumer", b =>
                {
                    ...
                    b.ToTable("outbox_message_consumers", "integrations");
                });
