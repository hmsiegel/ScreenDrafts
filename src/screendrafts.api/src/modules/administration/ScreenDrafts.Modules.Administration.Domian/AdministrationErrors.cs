...
{
  public static readonly SDError PasswordResetEmailFailed = SDError.Failure(
    "Administration.PasswordResetEmailFailed",
    "Failed to send password reset email."
  );

  public static SDError PermissionNotFound(string code) =>
    SDError.NotFound("Administration.PermissionNotFound", $"Permission '{code}' does not exist.");
  ...
  public static SDError UserHasNoRoles(Guid userId) =>
    SDError.NotFound("Administration.UserHasNoRoles", $"No roles found for user '{userId}'.");

  public static SDError UserNotFound(string publicId) =>
    SDError.NotFound("Administration.UserNotFound", $"No user found with public ID '{publicId}'.");
  ...
  public static SDError RoleNotFound(string roleName) =>
    SDError.NotFound("Administration.RoleNotFound", $"Role '{roleName}' does not exist.");
