...
using ScreenDrafts.Modules.Communications.Infrastructure.Database;

#nullable disable

namespace ScreenDrafts.Modules.Communications.Infrastructure.Database.Migrations
{
    [DbContext(typeof(CommunicationsDbContext))]
    [Migration("20250203035002_Add_InboxAndOutbox")]
            ...
            modelBuilder.Entity("ScreenDrafts.Common.Infrastructure.Inbox.InboxMessage", b =>
                {
                    ...
                    b.ToTable("inbox_messages", "communications");
                });
            ...
            modelBuilder.Entity("ScreenDrafts.Common.Infrastructure.Inbox.InboxMessageConsumer", b =>
                {
                    ...
                    b.ToTable("inbox_message_consumers", "communications");
                });
            ...
            modelBuilder.Entity("ScreenDrafts.Common.Infrastructure.Outbox.OutboxMessageConsumer", b =>
                {
                    ...
                    b.ToTable("outbox_message_consumers", "communications");
                });
