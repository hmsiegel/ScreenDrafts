...
internal sealed class ProcessOutboxJob(
    ...
    ICommunicationsDomainEventDispatcher domainEventDispatcher) : IJob
{
  ...
  private readonly ICommunicationsDomainEventDispatcher _domainEventDispatcher = domainEventDispatcher;
