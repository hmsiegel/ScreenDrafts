  ...
  protected override async Task ClearDatabaseAsync()
  {
    await DbContext.Database.ExecuteSqlRawAsync(
      ...
      TRUNCATE TABLE
        ...
        guest_drafts.commissioner_overrides,
        guest_drafts.veto_overrides,
        guest_drafts.vetoes,
        guest_drafts.pick_history,
        guest_drafts.picks,
        guest_drafts.draft_positions,
        guest_drafts.game_boards,
        guest_drafts.draft_participants,
        guest_drafts.drafts,
        guest_drafts.drafters,
        guest_drafts.movies
