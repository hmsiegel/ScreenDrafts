...
)
{
  ...
  {
    // Arrange
    var domainEvent = new CommissionerOverrideAppliedDomainEvent(
    ...
    var published = eventBus
      ...
      .Should()
      .BeOfType<GuestDraftCommissionerOverrideAppliedIntegrationEvent>()
      .Subject;
  ...
  public void Handler_ShouldBeDiscoverableByGuestDraftsModulesDomainEventHandlerRegistration()
  {
    ...
    handler.Should().BeAssignableTo<IDomainEventHandler<CommissionerOverrideAppliedDomainEvent>>();
  }
}
