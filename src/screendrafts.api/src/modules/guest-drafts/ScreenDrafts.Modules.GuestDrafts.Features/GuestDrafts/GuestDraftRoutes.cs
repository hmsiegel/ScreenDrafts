...
internal static class GuestDraftsRoutes
{
  ...
  internal const string PositionAssign =
    ById + "/positions/{positionPublicId}/assign";
  ...
  internal const string PickVetoOverride =
    PickByPlayOrder + "/veto-override";
  internal const string PickCommissionerOverride =
    PickByPlayOrder + "/commissioner-override";
  internal const string PickUndoVeto =
    PickByPlayOrder + "/undo-veto";
