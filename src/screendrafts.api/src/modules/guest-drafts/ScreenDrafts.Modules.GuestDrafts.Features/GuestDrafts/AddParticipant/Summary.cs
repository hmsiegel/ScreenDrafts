...
internal sealed class Summary : Summary<Endpoint>
{
  public Summary()
  {
    ...
    Description = "Owner-only. Adds a registered guest drafter as a participant, before the draft has started. The owner must add themselves too, like anyone else -- creating a draft no longer implies participating in it.";
    Response(StatusCodes.Status204NoContent, "Participant added.");
    Response(StatusCodes.Status400BadRequest, "Invalid AddParticipantRequest, or the draft has already started.");
