...
internal sealed class GuestDraftPickConfiguration : IEntityTypeConfiguration<GuestDraftPick>
{
  public void Configure(EntityTypeBuilder<GuestDraftPick> builder)
  {
    ...
    builder.Property(p => p.MoviePublicId)
      .IsRequired()
    ...
    builder.Property(p => p.PlayedByParticipantId)
      .IsRequired()
    ...
    builder.OwnsMany(
      ...
      history =>
      {
        ...
        history.Property(h => h.OccurredOnUtc)
          .IsRequired();
      });
