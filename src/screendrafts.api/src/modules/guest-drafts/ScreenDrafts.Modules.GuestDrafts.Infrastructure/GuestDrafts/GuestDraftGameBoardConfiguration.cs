...
internal sealed class GuestDraftGameBoardConfiguration : IEntityTypeConfiguration<GameBoard>
{
  public void Configure(EntityTypeBuilder<GameBoard> builder)
  {
    ...
    builder
      .Property(gb => gb.GuestDraftId)
      .IsRequired()
      .HasConversion(IdConverters.GuestDraftIdConverter);

    builder.HasIndex(gb => gb.GuestDraftId).IsUnique();
