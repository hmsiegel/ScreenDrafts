...
) : IJob
{
  ...
  private readonly IGuestDraftsDomainEventDispatcher _domainEventDispatcher = domainEventDispatcher;
  ...
  )
  {
    var sql = $"""
      ...
      FROM guest_drafts.outbox_messages
  ...
  {
    const string sql = """
      UPDATE guest_drafts.outbox_messages
