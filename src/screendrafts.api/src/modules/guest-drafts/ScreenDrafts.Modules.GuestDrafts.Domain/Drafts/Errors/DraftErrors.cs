...
public static class DraftErrors
{
  ...
  public static readonly SDError CannotChangeBoardAfterStart = SDError.Problem(
    "Drafts.CannotChangeBoardAfterStart",
  ...
  public static SDError DraftTypeDoesNotHaveAFixedLayout(string typeName) =>
    SDError.Problem(
      "Drafts.DraftTypeDoesNotHaveAFixedLayout",
  ...
  public static SDError DraftTypeHasAFixedLayout(string typeName) =>
    SDError.Problem(
      "Drafts.DraftTypeHasAFixedLayout",
  ...
  public static readonly SDError PositionDoesNotBelongToThisBoard = SDError.Problem(
    "Drafts.PositionDoesNotBelongToThisBoard",
  ...
  public static readonly SDError InvalidNumberOfPositions = SDError.Problem(
    "Drafts.InvalidNumberOfPositions",
  ...
  public static readonly SDError CannotStartWithoutAtLeastTwoParticipants = SDError.Problem(
    "Drafts.CannotStartWithoutAtLeastTwoParticipants",
  ...
  public static readonly SDError BoardMustBeFullySetUpBeforeStarting = SDError.Problem(
    "Drafts.BoardMustBeFullySetUpBeforeStarting",
  ...
  public static readonly SDError AllPositionsMustBeAssignedBeforeStarting = SDError.Problem(
    "Drafts.AllPositionsMustBeAssignedBeforeStarting",
  ...
  public static readonly SDError CannotCompleteIfNotInProgress = SDError.Problem(
    "Drafts.CannotCompleteIfNotInProgress",
  ...
  public static readonly SDError CannotCompleteWithoutAllPicks = SDError.Problem(
    "Drafts.CannotCompleteWithoutAllPicks",
  ...
  public static readonly SDError CommissionerOverrideAlreadyApplied = SDError.Conflict(
    "Drafts.CommissionerOverrideAlreadyApplied",
  ...
  public static readonly SDError PickRequiredForOverride = SDError.Problem(
    "Drafts.PickRequiredForOverride",
  ...
  public static readonly SDError VetoNotOnMostRecentPick = SDError.Problem(
    "Drafts.VetoNotOnMostRecentPick",
  ...
  public static readonly SDError NoRemainingVetoes = SDError.Problem(
    "Drafts.NoRemainingVetoes",
    "This participant has no remaining vetoes."
  );

  public static SDError VetoNotFound(Guid pickId) =>
    SDError.NotFound("Drafts.VetoNotFound", $"No active veto was found for pick {pickId}.");
  ...
  public static SDError PickNotFoundByPlayOrder(int playOrder) =>
    SDError.NotFound(
      "Drafts.PickNotFoundByPlayOrder",
  ...
  public static readonly SDError VetoOverridesNotAllowedForThisDraftType = SDError.Problem(
    "Drafts.VetoOverridesNotAllowedForThisDraftType",
  ...
  public static readonly SDError CommissionerOverrideNotOnMostRecentPick = SDError.Problem(
    "Drafts.CommissionerOverrideNotOnMostRecentPick",
  ...
  public static readonly SDError CannotAddParticipantAfterStart = SDError.Problem(
    "Drafts.CannotAddParticipantAfterStart",
  ...
  public static readonly SDError NumberOfPicksMustBeGreaterThanZero = SDError.Problem(
    "Drafts.NumberOfPicksMustBeGreaterThanZero",
  ...
  public static readonly SDError PositionsAreRequiredForThisDraftType = SDError.Problem(
    "Drafts.PositionsAreRequiredForThisDraftType",
  ...
  public static readonly SDError PositionsMustExactlyCoverTheNumberOfPicks = SDError.Problem(
    "Drafts.PositionsMustExactlyCoverTheNumberOfPicks",
  ...
  public static readonly SDError CannotChangeDraftTypeAfterStart = SDError.Problem(
    "Drafts.CannotChangeDraftTypeAfterStart",
