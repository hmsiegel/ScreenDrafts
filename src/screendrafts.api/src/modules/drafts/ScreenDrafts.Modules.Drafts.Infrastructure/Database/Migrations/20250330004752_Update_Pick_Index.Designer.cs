...
namespace ScreenDrafts.Modules.Drafts.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250330004752_Update_Pick_Index")]
    partial class Update_Pick_Index
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.Drafts.Entities.Pick", b =>
                {
                    ...
                    b.HasIndex("DraftId", "Position", "MovieId")
                        .IsUnique()
                        .HasDatabaseName("ix_picks_draft_id_position_movie_id");
