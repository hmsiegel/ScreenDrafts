...
namespace ScreenDrafts.Modules.Drafts.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260213185309_Update_EpisodeNumber_Draft_DraftPart")]
    partial class Update_EpisodeNumber_Draft_DraftPart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.DraftRelease", b =>
                {
                    ...
                    b.HasIndex("DraftId")
                        .HasDatabaseName("ix_draft_releases_draft_id");

                    b.HasIndex("ReleaseChannel", "ReleaseDate")
                        .HasDatabaseName("ix_draft_releases_release_channel_release_date");

                    b.HasIndex("ReleaseChannel", "EpisodeNumber", "DraftId")
                        .IsUnique()
                        .HasDatabaseName("ux_draft_releases_channel_episode_number")
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.DraftRelease", b =>
                {
                    b.HasOne("ScreenDrafts.Modules.Drafts.Domain.Drafts.Draft", "Draft")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_draft_releases_drafts_draft_id");
