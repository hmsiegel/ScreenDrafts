...
namespace ScreenDrafts.Modules.Drafts.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260214150842_Add_DraftChannelRelease")]
    partial class Add_DraftChannelRelease
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.Drafts.Entities.DraftChannelRelease", b =>
                {
                    ...
                    b.HasIndex("ReleaseChannel", "EpisodeNumber")
                        .IsUnique()
                        .HasDatabaseName("ux_draft_channel_releases_channel_episode_number")
