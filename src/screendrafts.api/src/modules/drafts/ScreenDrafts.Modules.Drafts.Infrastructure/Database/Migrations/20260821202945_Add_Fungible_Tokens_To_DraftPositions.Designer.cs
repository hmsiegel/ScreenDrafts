...
namespace ScreenDrafts.Modules.Drafts.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260821202945_Add_Fungible_Tokens_To_DraftPositions")]
    partial class Add_Fungible_Tokens_To_DraftPositions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.DraftPart", b =>
                {
                    ...
                    b.Property<int?>("SubDraftCount")
                        .HasColumnType("integer")
                        .HasColumnName("sub_draft_count");
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.CandidateListEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<string>("AddedByPublicId")
                        .IsRequired()
                        .HasMaxLength(19)
                        .HasColumnType("character varying(19)")
                        .HasColumnName("added_by_public_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_candidate_list_entries");

                    b.HasIndex("DraftPartId", "TmdbId")
                        .IsUnique()
                        .HasDatabaseName("ix_candidate_list_entries_draft_part_id_tmdb_id");

                    b.HasIndex("TmdbId", "IsPending")
                        .HasDatabaseName("ix_candidate_list_entries_tmdb_id_is_pending");

                    b.ToTable("candidate_list_entries", "drafts");
                });
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.DraftPosition", b =>
                {
                    ...
                    b.Property<bool>("HasFungibleToken")
                        .HasColumnType("boolean")
                        .HasColumnName("has_fungible_token");
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.DraftRelease", b =>
                {
                    ...
                    b.HasKey("PartId", "ReleaseChannel")
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.GameBoard", b =>
                {
                    ...
                    b.HasIndex("SubDraftId")
                        .IsUnique()
                        .HasDatabaseName("ix_game_boards_sub_draft_id");
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.Pick", b =>
                {
                    ...
                    b.Property<Guid>("PlayedByParticipantIdValue")
                        .HasColumnType("uuid")
                        .HasColumnName("played_by_participant_id_value");

                    b.Property<int>("PlayedByParticipantKindValue")
                        .HasColumnType("integer")
                        .HasColumnName("played_by_participant_kind_value");
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.SubDraft", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_sub_drafts");

                    b.HasIndex("PublicId")
                        .IsUnique()
                        .HasDatabaseName("ix_sub_drafts_public_id");

                    b.HasIndex("DraftPartId", "Index")
                        .IsUnique()
                        .HasDatabaseName("ix_sub_drafts_draft_part_id_index");
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.Drafts.Entities.DraftChannelRelease", b =>
                {
                    b.Property<Guid>("DraftId")
                        .HasColumnType("uuid")
                        .HasColumnName("draft_id");
                    ...
                    b.HasKey("DraftId", "ReleaseChannel")
                        .HasName("pk_draft_channel_releases");

                    b.HasIndex("SeriesId")
                        .HasDatabaseName("ix_draft_channel_releases_series_id");

                    b.HasIndex("ReleaseChannel", "EpisodeNumber", "SeriesId")
                        .IsUnique()
                        .HasDatabaseName("ux_draft_channel_releases_channel_series_episode_number")
                        .HasFilter("episode_number is not null");

                    b.ToTable("draft_channel_releases", "drafts");
                });
                    ...
                    b.OwnsMany("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.CommunityFilmRule", "_communityFilmRules", b1 =>
                        {
                            ...
                            b1.Property<int>("RuleKind")
                                .HasColumnType("integer")
                                .HasColumnName("rule_kind");

                            b1.Property<int?>("TargetSlot")
                                .HasColumnType("integer")
                            ...
                            b1.WithOwner()
                                ...
                                .HasConstraintName("fk_draft_part_community_film_rules_draft_parts_draft_part_id");
                        });
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.CandidateListEntry", b =>
                {
                    b.HasOne("ScreenDrafts.Modules.Drafts.Domain.DraftParts.DraftPart", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_candidate_list_entries_draft_parts_draft_part_id");
                });

            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.CommissionerOverride", b =>
                {
                    b.HasOne("ScreenDrafts.Modules.Drafts.Domain.DraftParts.Entities.Pick", "Pick")
            ...
            modelBuilder.Entity("ScreenDrafts.Modules.Drafts.Domain.Drafts.Entities.DraftChannelRelease", b =>
                {
                    b.HasOne("ScreenDrafts.Modules.Drafts.Domain.Drafts.Draft", "Draft")
                        .WithMany("ChannelReleases")
                        .HasForeignKey("DraftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_draft_channel_releases_drafts_draft_id");
                    ...
                    b.HasOne("ScreenDrafts.Modules.Drafts.Domain.SeriesAggregate.Series", "Series")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_draft_channel_releases_series_series_id");
