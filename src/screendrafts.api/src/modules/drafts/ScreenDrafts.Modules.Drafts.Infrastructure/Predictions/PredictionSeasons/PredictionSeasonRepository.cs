...
internal sealed class PredictionSeasonRepository(DraftsDbContext dbContext)
  : IPredictionSeasonRepository
{
  ...
  public Task<bool> ExistsByNumberAsync(int number, CancellationToken cancellationToken = default)
  {
    return _dbContext.PredictionSeasons.AnyAsync(x => x.Number == number, cancellationToken);
  }
  ...
  public async Task<PredictionSeason?> GetByIdAsync(
    PredictionSeasonId id,
    CancellationToken cancellationToken
  )
  {
    return await _dbContext
      .PredictionSeasons.Include(s => s.Standings)
  ...
  public async Task<PredictionSeason?> GetByPublicIdAsync(
    string publicId,
    CancellationToken cancellationToken
  )
  {
  ...
  public async Task<PredictionSeason?> GetCurrentAsync(
