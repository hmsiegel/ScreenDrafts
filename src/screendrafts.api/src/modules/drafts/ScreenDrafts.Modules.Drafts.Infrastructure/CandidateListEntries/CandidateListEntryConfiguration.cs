...
internal sealed class CandidateListEntryConfiguration : IEntityTypeConfiguration<CandidateListEntry>
{
  public void Configure(EntityTypeBuilder<CandidateListEntry> builder)
  {
    ...
    builder.Property(x => x.IsPicked).IsRequired();

    builder.Property(x => x.PickId).HasConversion(IdConverters.NullablePickIdConverter);
    ...
    builder.HasIndex(x => new { x.DraftPartId, x.TmdbId }).IsUnique();
