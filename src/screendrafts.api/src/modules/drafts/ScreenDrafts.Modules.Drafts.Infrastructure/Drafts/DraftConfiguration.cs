...
internal sealed class DraftConfiguration : IEntityTypeConfiguration<Draft>
{
  public void Configure(EntityTypeBuilder<Draft> builder)
  {
    ...
    builder.HasIndex(d => d.PublicId).IsUnique().HasDatabaseName("ix_drafts_public_id");
    ...
    builder
      ...
      .HasConversion(draftType => draftType.Value, value => DraftType.FromValue(value));

    builder
      .Property(d => d.DraftStatus)
      .HasConversion(draftStatus => draftStatus.Value, value => DraftStatus.FromValue(value));
    ...
    builder
      .Navigation(x => x.Parts)
      .HasField("_parts")
      .UsePropertyAccessMode(PropertyAccessMode.Field);

    builder
      .Navigation(x => x.DraftCategories)
      .HasField("_draftCategories")
      .UsePropertyAccessMode(PropertyAccessMode.Field);

    builder
      .Navigation(x => x.ChannelReleases)
