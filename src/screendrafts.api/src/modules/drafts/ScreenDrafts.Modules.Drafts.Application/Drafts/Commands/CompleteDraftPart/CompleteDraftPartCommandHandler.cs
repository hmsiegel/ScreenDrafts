...
internal sealed class CompleteDraftPartCommandHandler(
  IDraftsRepository draftsRepository)
  : ICommandHandler<CompleteDraftPartCommand>
{
  private readonly IDraftsRepository _draftsRepository = draftsRepository;

  public async Task<Result> Handle(CompleteDraftPartCommand request, CancellationToken cancellationToken)
  {
