...
internal sealed class PauseDraftPartCommandHandler(
  IDraftsRepository draftsRepository)
  : ICommandHandler<PauseDraftPartCommand>
{
  private readonly IDraftsRepository _draftsRepository = draftsRepository;

  public async Task<Result> Handle(PauseDraftPartCommand request, CancellationToken cancellationToken)
  {
