...
public sealed class ApplySubDraftVetoTests(DraftsIntegrationTestWebAppFactory factory)
  : DraftsIntegrationTest(factory)
{
  ...
  public async Task ApplySubDraftVeto_WithValidData_ShouldSucceedAsync()
  {
    ...
    var command = new ApplySubDraftVetoCommand
    {
      ...
      SubDraftPublicId = subDraftPublicId,
      PlayOrder = 1,
      IssuerPublicId = drafter1PublicId,
      IssuerKind = ParticipantKind.Drafter
    };
  ...
  [Fact]
  public async Task ApplySubDraftVeto_ShouldPersistVetoOnPickAsync()
  {
    // Arrange
    var (draftPartPublicId, subDraftPublicId, drafter1PublicId, _) = await SetupActiveSubDraftAsync();
    var movie = await CreateMovieAsync();
  ...
  [Fact]
  public async Task ApplySubDraftVeto_WithNonExistentDraftPart_ShouldFailAsync()
  {
    // Arrange
    ...
    var command = new ApplySubDraftVetoCommand
    {
      ...
      PlayOrder = 1,
      IssuerPublicId = drafterPublicId,
      IssuerKind = ParticipantKind.Drafter
    };
  ...
  [Fact]
  public async Task ApplySubDraftVeto_WithNonExistentSubDraft_ShouldFailAsync()
  {
    // Arrange
  ...
  [Fact]
  public async Task ApplySubDraftVeto_WhenSubDraftIsPending_ShouldFailAsync()
  {
    // Arrange
  ...
  [Fact]
  public async Task ApplySubDraftVeto_WithNonExistentPlayOrder_ShouldFailAsync()
  {
    // Arrange
    var (draftPartPublicId, subDraftPublicId, drafter1PublicId, _) = await SetupActiveSubDraftAsync();
