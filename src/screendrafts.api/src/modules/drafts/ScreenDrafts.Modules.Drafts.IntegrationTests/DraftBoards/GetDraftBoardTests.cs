  ...
  : DraftsIntegrationTest(factory)
{
  ...
  public async Task GetDraftBoard_AfterAddingMovie_ShouldSucceedAsync()
  {
    ...
    await Sender.Send(
      new AddMovieToDraftBoardCommand
      {
    ...
    var query = new GetDraftBoardQuery { DraftId = draftPublicId, UserId = userId };
  ...
  public async Task GetDraftBoard_WithNoItems_ShouldReturnEmptyItemListAsync()
  {
    ...
    await Sender.Send(
      new RemoveMovieFromDraftBoardCommand
      {
        DraftId = draftPublicId,
        UserPublicId = userPublicId,
        TmdbId = tmdbId,
  ...
  [Fact]
  public async Task GetDraftBoard_WhenBoardNotFound_ShouldCreateDraftBoardAsync()
  {
    ...
    result.Value.DraftId.Should().Be(draftPublicId);
    result.Value.Items.Should().BeEmpty();
    result.Value.PublicId.Should().BeEmpty();
  }
