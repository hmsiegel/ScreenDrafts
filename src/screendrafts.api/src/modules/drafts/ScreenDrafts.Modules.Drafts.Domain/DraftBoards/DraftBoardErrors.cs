...
public static class DraftBoardErrors
{
  ...
  public static readonly SDError PoolSourcedBoardCannotBeModifiedDirectly = SDError.Failure(
    "DraftBoardErrors.PoolSourcedBoardCannotBeModifiedDirectly",
    "Pool-sourced boards cannot be modified directly."
  );

  public static readonly SDError BoardIsLocked = SDError.Failure(
    "DraftBoardErrors.BoardIsLocked",
    "The board is locked."
  );
