...
{
  public static readonly SDError InvalidFirstName = SDError.Failure(
    "PersonError.InvalidFirstName",
    "First name cannot be empty or whitespace."
  );

  public static readonly SDError InvalidLastName = SDError.Failure(
    "PersonError.InvalidFirstName",
    "First name cannot be empty or whitespace."
  );
  ...
  public static readonly SDError CannotCreatePerson = SDError.Failure(
    "PersonError.CannotCreatePerson",
    "Cannot create person without user ID or name."
  );

  public static readonly SDError InvalidAvatarContentType = SDError.Failure(
    "PersonError.InvalidAvatarContentType",
    "Invalid file type. Allowed types are: JPEG, PNG, WEBP."
  );

  public static SDError NotFound(Guid userId) =>
    SDError.NotFound("PersonError.NotFound", $"Unable to find a person with user ID {userId}.");

  public static SDError NotFound(string publicId) =>
    SDError.NotFound("PersonError.NotFound", $"Unable to find a person with public ID {publicId}.");
