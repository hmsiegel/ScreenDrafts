...
public static class PredictionErrors
{
  ...
  public static SDError SetNotFound(string publicId) =>
    SDError.NotFound("PredictionErrors.SetNotFound", $"Prediction set '{publicId}' was not found.");
  ...
  public static readonly SDError DuplicateContestantInPredictorList = SDError.Conflict(
    "PredictionErrors.DuplicateContestantInPredictorList",
    "The same contestant appears more than once in the predictor list."
  );

  public static readonly SDError NotAuthorizedToSubmit = SDError.Forbidden(
    "PredictionErrors.NotAuthorizedToSubmit",
    "You are not authorized to submit predictions for this contestant."
  );

  public static SDError PredictorNotConfigured(string contestantPublicId) =>
    SDError.NotFound(
      "PredictionErrors.PredictorNotConfigured",
      $"Contestant '{contestantPublicId}' is not a configured predictor for this draft part."
    );

  public static SDError SubmitterPersonNotFound(string personPublicId) =>
    SDError.NotFound(
