...
public static class SeriesErrors
{
  ...
  public static SDError SeriesNotFound(Guid seriesId) =>
    SDError.NotFound("Series.SeriesNotFound", $"Series with id {seriesId} was not found.");

  public static SDError SeriesNotFound(string publicId) =>
    SDError.NotFound("Series.SeriesNotFound", $"Series with public id '{publicId}' was not found.");
  ...
  public static readonly SDError RequiredDraftTypeMustBeIncludedInAllowedDraftTypes =
    SDError.Problem(
      "Series.RequiredDraftTypeMustBeIncludedInAllowedDraftTypes",
      "Required draft type must be included in allowed draft types."
    );

  public static readonly SDError DefaultDraftTypeMustBeIncludedInAllowedDraftTypes =
    SDError.Problem(
