...
public static partial class DraftErrors
{
  public static SDError NotFound(Guid draftId) =>
    SDError.NotFound("Drafts.NotFound", $"Draft with id {draftId} was not found.");

  public static SDError NotFound(string publicId) =>
    SDError.NotFound("Drafts.NotFound", $"Draft with public id {publicId} was not found.");
  ...
  public static readonly SDError DraftCanOnlyBeStartedIfItIsCreated = SDError.Problem(
    "Drafts.DraftCanOnlyBeStartedIfItIsCreated",
    "Draft can only be started if it is created."
  );

  public static readonly SDError CannotStartDraftWithoutAllDrafters = SDError.Problem(
    "Drafts.CannotStartDraftWithoutAllDrafters",
    "Cannot start the draft without all drafters."
  );

  public static readonly SDError CannotStartDraftWithoutAllHosts = SDError.Problem(
    "Drafts.CannotStartDraftWithoutAllHosts",
    "Cannot start the draft without all hosts."
  );

  public static readonly SDError CannotCompleteDraftIfItIsNotInProgress = SDError.Problem(
    "Drafts.CannotCompleteDraftIfItIsNotInProgress",
    "Cannot complete the draft if it is not in progress."
  );

  public static readonly SDError CannotCompleteDraftWithoutAllPicks = SDError.Problem(
  ...
  public static readonly SDError CommissionerOverridesNotFound = SDError.NotFound(
    "Drafts.CommissionerOverridesNotFound",
    "No commissioner overrides were found."
  );

  public static readonly SDError CommissionerOverrideCannotBeApplied = SDError.Problem(
    "Drafts.CommissionerOverrideCannotBeApplied",
    "Commissioner override cannot be applied."
  );

  public static readonly SDError CannotContinueDraftIfItIsNotPaused = SDError.Problem(
  ...
  public static readonly SDError EpisodeNumberMustBeGreaterThanZero = SDError.Problem(
    "Drafts.EpisodeNumberMustBeGreaterThanZero",
    "Episode number must be greater than zero."
  );

  public static readonly SDError NoSeriesLinked = SDError.Problem(
    "Drafts.NoSeriesLinked",
    "No series is linked to the draft."
  );

  public static readonly SDError CommunityPicksNotAllowedInThisDraftPart = SDError.Problem(
    "Drafts.CommunityPicksNotAllowedInThisDraftPart",
    "Community picks are not allowed in this draft part."
  );

  public static readonly SDError NoRemainingCommunityPicks = SDError.Problem(
  ...
  public static readonly SDError NoScheduledDraftPartToContinue = SDError.Problem(
    "Drafts.NoScheduledDraftPartToContinue",
    "There is no scheduled draft part to continue at this time."
  );

  public static readonly SDError InvalidDraftPartStatusAction = SDError.Problem(
    "Drafts.InvalidDraftPartStatusAction",
    "The requested draft part status action is invalid."
  );

  public static readonly SDError CannotChangeASeriesAfterADraftPartHasStarted = SDError.Conflict(
  ...
  public static readonly SDError SeriesIdIsRequired = SDError.Problem(
    "Drafts.SeriesIdIsRequired",
    "Series id is required."
  );

  public static readonly SDError TotalPicksIsOutOfRange = SDError.Problem(
  ...
  public static readonly SDError SeriesIsRequired = SDError.Problem(
    "Drafts.SeriesIsRequired",
    "Series is required."
  );

  public static readonly SDError OneOrMoreCategoriesNotFound = SDError.NotFound(
    "Drafts.OneOrMoreCategoriesNotFound",
    "One or more categories were not found."
  );

  public static readonly SDError InvalidImageContentType = SDError.Problem(
    "Drafts.InvalidImageContentType",
