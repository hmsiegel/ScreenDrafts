...
{
  public static readonly SDError PickAlreadyExists = SDError.Conflict(
    "Picks.PickAlreadyExists",
    "A pick already exists for this drafter."
  );

  public static SDError NotFound(Guid pickId) =>
    SDError.NotFound("Picks.NotFound", $"Pick with ID {pickId} not found.");
  ...
  public static readonly SDError CommissionerOverrideAlreadyApplied = SDError.Problem(
  ...
  public static readonly SDError VetoMustBeProvided = SDError.Problem(
    "Picks.VetoMustBeProvided",
    "Veto must be provided."
  );

  public static readonly SDError DraftMustBeProvided = SDError.Problem(
    "Picks.DraftMustBeProvided",
    "Draft must be provided."
  );

  public static readonly SDError DrafterOrTeamMustBeProvided = SDError.Problem(
  ...
  public static readonly SDError DrafterAndTeamCannotBeProvided = SDError.Problem(
  ...
  public static readonly SDError CannotOverrideAPickThatHasNotBeenVetoed = SDError.Conflict(
    "Picks.CannotOverrideAPickThatHasNotBeenVetoed",
    "Cannot override a pick that has not been vetoed."
  );

  public static readonly SDError ParticipantNotInDraftPart = SDError.Conflict(
    "Picks.ParticipantNotInDraftPart",
    "The participant making the pick is not part of the draft part."
  );

  public static readonly SDError PickCreationFailed = SDError.Problem(
    "Picks.PickCreationFailed",
    "Failed to create the pick."
  );

  public static readonly SDError PartPositionsNotSet = SDError.Problem(
    "Picks.PartPositionsNotSet",
    "The draft part does not have valid min and max positions set."
  );

  public static readonly SDError InvalidPartPositionRange = SDError.Problem(
  ...
  public static readonly SDError PickNotVetoed = SDError.Conflict(
    "Picks.PickNotVetoed",
    "Cannot undo a veto on a pick that has not been vetoed."
  );
  public static readonly SDError CannotUndoVetoThatHasBeenOverridden = SDError.Conflict(
    "Picks.CannotUndoVetoThatHasBeenOverridden",
    "Cannot undo a veto that has been overridden."
  );
}
