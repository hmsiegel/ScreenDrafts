  ...
  : IQueryHandler<GetDraftQuery, GetDraftResponse>
{
  ...
  )
  {
    ...
    const string draftSql = $"""
      SELECT
        ...
        d.restricted_tv_series_tmdb_id AS {nameof(GetDraftResponse.RestrictedTvSeriesTmdbId)},
        d.restricted_tv_series_title AS {nameof(GetDraftResponse.RestrictedTvSeriesTitle)},
  ...
  private static GetDraftResponse BuildResponse(
    ...
    new()
    {
      ...
      RestrictedTvSeriesTitle = draft.RestrictedTvSeriesTitle,
