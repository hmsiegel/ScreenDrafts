...
internal sealed class Summary : Summary<Endpoint>
{
  public Summary()
  {
    ...
    Description =
      "Sets the status of a specific part of a draft identified by its public ID and part index.";
    Response<SetDraftPartStatusResponse>(
      StatusCodes.Status200OK,
      "The draft part status has been successfully updated."
    );
