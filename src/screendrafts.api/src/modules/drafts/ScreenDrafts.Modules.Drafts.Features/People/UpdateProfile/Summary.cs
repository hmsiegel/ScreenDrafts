...
internal sealed class Summary : Summary<Endpoint>
{
  public Summary()
  {
    ...
    Description =
      "Update a person's profile with the provided information. This endpoint allows you to modify the profile details of a person in the system.";
    Response(StatusCodes.Status204NoContent, "The person's profile was successfully updated.");
    Response(
