...
internal sealed class QueryHandler(IDbConnectionFactory connectionFactory) : IQueryHandler<Query, PeopleCollectionResponse>
{
  private readonly IDbConnectionFactory _connectionFactory = connectionFactory;

  public async Task<Result<PeopleCollectionResponse>> Handle(Query request, CancellationToken cancellationToken)
  {
