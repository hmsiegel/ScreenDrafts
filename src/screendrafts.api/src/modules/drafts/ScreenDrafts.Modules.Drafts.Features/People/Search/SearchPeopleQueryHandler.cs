...
internal sealed class SearchPeopleQueryHandler(IDbConnectionFactory dbConnectionFactory) : IQueryHandler<SearchPeopleQuery, PeopleSearchResponse>
{
  private readonly IDbConnectionFactory _dbConnectionFactory = dbConnectionFactory;

  public async Task<Result<PeopleSearchResponse>> Handle(SearchPeopleQuery SearchPeopleRequest, CancellationToken cancellationToken)
  {
    ...
    var items = await connection.QueryAsync<PersonSearchItem>(new CommandDefinition(
      ...
      parameters: new
      {
        SearchPeopleRequest.Search,
        SearchPeopleRequest.Limit
      },
