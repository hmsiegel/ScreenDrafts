...
internal sealed class Summary : Summary<Endpoint>
{
  public Summary()
  {
    ...
    Description =
      "Submits a contestant's film predictions for a draft part. Entry count must match the rules RequiredCount. Use SourceKind=1 for CSV uploads.";
    ...
    Response(
      ...
      "A set already exists for this contestant and draft part, or the deadline has passed."
    );
