...
internal sealed class QueryHandler(IDbConnectionFactory connectionFactory)
  : IQueryHandler<Query, DrafterCollectionResponse>
{
  private readonly IDbConnectionFactory _connectionFactory = connectionFactory;

  public async Task<Result<DrafterCollectionResponse>> Handle(Query request, CancellationToken cancellationToken)
  {
