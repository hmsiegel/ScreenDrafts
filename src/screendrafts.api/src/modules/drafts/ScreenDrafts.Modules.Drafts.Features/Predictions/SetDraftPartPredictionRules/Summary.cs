...
internal sealed class Summary : Summary<Endpoint>
{
  public Summary()
  {
    ...
    Description =
      "Defines how Commissioner Predictions are scored for a specific draft part. Can only be set once — update not supported by design.";
    Response(StatusCodes.Status204NoContent, "The rules were successfully set.");
    Response(
      StatusCodes.Status400BadRequest,
      "Validation failed or invalid mode/TopN combination."
    );
