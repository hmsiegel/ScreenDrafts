...
internal sealed class Summary : Summary<Endpoint>
{
  public Summary()
  {
    ...
    Description = "Returns a reference list of campaigns, sorted by name. Administrators may pass an optional ListCampaignsQuery parameter to include deleted campaigns.";
