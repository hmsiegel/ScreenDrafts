...
{
  public static readonly SDError EmailInUse = SDError.Conflict(
  ...
  public static readonly SDError InvalidName = SDError.Failure(
    "UserErrors.InvalidName",
    "The first name and last name must be at least 2 characters long."
  );

  public static readonly SDError PasswordTooShort = SDError.Failure(
  ...
  public static readonly SDError RoleDoesNotExist = SDError.NotFound(
    "UserErrors.RoleDoesNotExist",
    "The role does not exist."
  );

  public static readonly SDError CannotRemoveLastRole = SDError.Problem(
    "UserErrors.CannotRemoveLastRole",
    "The user must have at least one role."
  );

  public static readonly SDError PasswordsDoNotMatch = SDError.Failure(
