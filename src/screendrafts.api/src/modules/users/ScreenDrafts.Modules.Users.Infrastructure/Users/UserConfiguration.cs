...
internal sealed class UserConfiguration : IEntityTypeConfiguration<User>
{
  public void Configure(EntityTypeBuilder<User> builder)
  {
    ...
    builder.Property(u => u.IdentityId).IsRequired().HasMaxLength(255);
    ...
    builder
      ...
      .HasConversion(u => u.Value, value => FirstName.Create(value!).Value);

    builder
      .Property(u => u.LastName)
      .HasMaxLength(LastName.MaxLength)
      .HasConversion(u => u.Value, value => LastName.Create(value!).Value);

    builder
      .Property(u => u.Email)
      .HasMaxLength(Email.MaxLength)
      .HasConversion(u => u.Value, value => Email.Create(value!).Value);
