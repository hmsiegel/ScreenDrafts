...
internal sealed class ProcessOutboxJob(
    ...
    IMoviesDomainEventDispatcher domainEventDispatcher) : IJob
{
  ...
  private readonly IMoviesDomainEventDispatcher _domainEventDispatcher = domainEventDispatcher;
