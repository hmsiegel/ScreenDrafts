...
public static class MediaErrors
{
  ...
  public static readonly SDError RequiredFieldsMissing = SDError.Failure(
    "Media.RequiredFieldsMissing",
    "The title and IMDB ID are required fields."
  );

  public static readonly SDError SearchQueryRequired = SDError.Failure(
    "Media.SearchQueryRequired",
    "The search query is required."
  );

  public static readonly SDError IgdbIdRequiredForVideoGames = SDError.Failure(
    "Media.IgdbIdRequiredForVideoGames",
    "The IGDB ID is required for video games."
  );

  public static readonly SDError TmdbIdRequired = SDError.Failure(
    "Media.TmdbIdRequired",
    "The TMDB ID is required for movies, TV shows, and TV episodes."
  );

  public static readonly SDError EpisodeFieldsRequired = SDError.Failure(
    "Media.EpisodeFieldsRequired",
    "The TV episode fields are required."
  );

  public static readonly SDError PublicIdRequired = SDError.Failure(
    "Media.PublicIdRequired",
    "Public Id is required"
  );

  public static readonly SDError ExternalIdsRequiredForShorts = SDError.Failure(
    "Media.ExternalIdsRequiredForShorts",
    "An external ID is required for short films."
  );

  public static readonly SDError ImdbOrExternalIdRequiredForMusicVideos = SDError.Failure(
    "Media.ImdbOrExternalIdRequiredForMusicVideos",
    "An IMDb ID or an external ID is required for music videos."
  );
}
