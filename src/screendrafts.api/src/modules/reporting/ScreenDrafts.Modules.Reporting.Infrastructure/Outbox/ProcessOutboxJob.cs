namespace ScreenDrafts.Modules.Reporting.Infrastructure.Outbox;
...
internal sealed class ProcessOutboxJob(
    ...
    IReportingDomainEventDispatcher domainEventDispatcher) : IJob
{
  ...
  private readonly IReportingDomainEventDispatcher _domainEventDispatcher = domainEventDispatcher;
      ...
      IDbTransaction transaction)
  {
    var sql =
        $"""
             ...
             FROM reporting.outbox_messages
      ...
      Exception? exception)
  {
    const string sql =
        """
            UPDATE reporting.outbox_messages
