...
internal static class ConnectionStringExtensions
{
  [System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    Justification = "Dummy credentials for design-time only"
  )]
  private const string Dummy =
    "Host=localhost;Port=5432;Database=dummy;Username=postgres;Password=postgres";
  ...
  {
    var isDesignTime =
      AppDomain.CurrentDomain.FriendlyName.StartsWith("NSwag", StringComparison.OrdinalIgnoreCase)
