...
BEGIN
    ...
    VALUES ('20260209151650_Initial_Drafts', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260211122547_Add_PlayedByParticipantIdentity_ToPicks') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260211122547_Add_PlayedByParticipantIdentity_ToPicks', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260212121413_RemoveCommissionerOverrideIdFromPick') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260212121413_RemoveCommissionerOverrideIdFromPick', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260213185309_Update_EpisodeNumber_Draft_DraftPart') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260213185309_Update_EpisodeNumber_Draft_DraftPart', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260214150842_Add_DraftChannelRelease') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260214150842_Add_DraftChannelRelease', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260215211450_Add_Series_To_DraftChannelRelease') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260215211450_Add_Series_To_DraftChannelRelease', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260220213402_Add_PublicIds') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260220213402_Add_PublicIds', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260221163304_Update_DrafterTeams') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260221163304_Update_DrafterTeams', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260222193556_Add_DraftPart_PublicId_Nullable') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260222193556_Add_DraftPart_PublicId_Nullable', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260222213159_Add_DraftPart_PublicId_NotNull') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260222213159_Add_DraftPart_PublicId_NotNull', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260226183026_AddActedByPublicIdToDraftEntities') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260226183026_AddActedByPublicIdToDraftEntities', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260226211326_Add_DraftPosition_PublicId_Null') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260226211326_Add_DraftPosition_PublicId_Null', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260226230153_Add_DraftPosition_PublicId_NotNull') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260226230153_Add_DraftPosition_PublicId_NotNull', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260308202402_Add_Tmdb_Id_Null') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260308202402_Add_Tmdb_Id_Null', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260311152702_Add_DraftBoards') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260311152702_Add_DraftBoards', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260312174747_Add_DraftPools') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260312174747_Add_DraftPools', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260312201336_Remove_DraftPoolItem_TmdbId_Identity') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260312201336_Remove_DraftPoolItem_TmdbId_Identity', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260316113651_Add_Candidate_Lists') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260316113651_Add_Candidate_Lists', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260320015514_AddCommunityLimitsAndSeriesPolicy') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260320015514_AddCommunityLimitsAndSeriesPolicy', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260322152439_Update_Media') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260322152439_Update_Media', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260326115012_Update_ImdbId_Keys') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260326115012_Update_ImdbId_Keys', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260331134530_Add_SpeedDrafts') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260331134530_Add_SpeedDrafts', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260406105411_Update_SpeedDrafts') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260406105411_Update_SpeedDrafts', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260408173043_Add_Predictions') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260408173043_Add_Predictions', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260409161113_Update_Predictions_Public_Ids') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260409161113_Update_Predictions_Public_Ids', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260409200119_Add_Sub_DraftId_to_Picks') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260409200119_Add_Sub_DraftId_to_Picks', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260424123644_Add_Zoom') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260424123644_Add_Zoom', '10.0.6');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260425114113_Add_Pick_Visibility') THEN
    UPDATE drafts.picks SET revealed_at = NOW() WHERE revealed_at IS NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260425114113_Add_Pick_Visibility') THEN
    INSERT INTO drafts."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260425114113_Add_Pick_Visibility', '10.0.6');
    END IF;
END $EF$;
COMMIT;
