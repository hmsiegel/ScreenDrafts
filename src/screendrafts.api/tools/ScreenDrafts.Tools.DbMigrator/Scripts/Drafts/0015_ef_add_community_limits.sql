...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260320015514_AddCommunityLimitsAndSeriesPolicy') THEN
    ALTER TABLE drafts.draft_part_participants RENAME COLUMN trivia_vetoes TO vetoes_rolling_in;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260320015514_AddCommunityLimitsAndSeriesPolicy') THEN
    ALTER TABLE drafts.draft_part_participants RENAME COLUMN trivia_veto_overrides TO veto_overrides_rolling_in;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260320015514_AddCommunityLimitsAndSeriesPolicy') THEN
    ALTER TABLE drafts.draft_part_participants RENAME COLUMN rollover_veto_override TO awarded_vetoes;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM drafts."__EFMigrationsHistory" WHERE "migration_id" = '20260320015514_AddCommunityLimitsAndSeriesPolicy') THEN
    ALTER TABLE drafts.draft_part_participants RENAME COLUMN rollover_veto TO awarded_veto_overrides;
    END IF;
END $EF$;
