...
BEGIN
    ...
    VALUES ('20250326005904_Add_Initial', '10.0.11');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260308202714_Add_Tmdb_Id_Null') THEN
    INSERT INTO movies."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260308202714_Add_Tmdb_Id_Null', '10.0.11');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260322153034_Update_Media') THEN
    INSERT INTO movies."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260322153034_Update_Media', '10.0.11');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260326114731_Update_ImdbId_and_FK') THEN
    INSERT INTO movies."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260326114731_Update_ImdbId_and_FK', '10.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260607014306_Add_Nullable_IMDbId') THEN
    ALTER TABLE movies.production_companies ALTER COLUMN imdb_id DROP NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260607014306_Add_Nullable_IMDbId') THEN
    ALTER TABLE movies.people ALTER COLUMN imdb_id DROP NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260607014306_Add_Nullable_IMDbId') THEN
    INSERT INTO movies."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260607014306_Add_Nullable_IMDbId', '10.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260724173218_Add_ExternalId_Index') THEN
    CREATE INDEX ix_media_external_id ON movies.media (external_id);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260724173218_Add_ExternalId_Index') THEN
    INSERT INTO movies."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260724173218_Add_ExternalId_Index', '10.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260829022352_Add_TmdbTvSeries_Episodes') THEN
    ALTER TABLE movies.media ADD tv_series_title character varying(200);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260829022352_Add_TmdbTvSeries_Episodes') THEN
    INSERT INTO movies."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260829022352_Add_TmdbTvSeries_Episodes', '10.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260910184346_Refactor_Movie_Configuration') THEN
    DROP INDEX IF EXISTS movies.ix_media_tmdb_id;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260910184346_Refactor_Movie_Configuration') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS ix_media_tmdb_id_media_type ON movies.media (tmdb_id, media_type) WHERE tmdb_id IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM movies."__EFMigrationsHistory" WHERE "migration_id" = '20260910184346_Refactor_Movie_Configuration') THEN
    INSERT INTO movies."__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260910184346_Refactor_Movie_Configuration', '10.0.11');
    END IF;
END $EF$;
COMMIT;
