...
public class RolesController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(ScreenDraftsAction.View, ScreenDraftsResource.Roles)]
    ...
    [MustHavePermission(ScreenDraftsAction.View, ScreenDraftsResource.RoleClaims)]
    ...
    [MustHavePermission(ScreenDraftsAction.Update, ScreenDraftsResource.RoleClaims)]
    ...
    [HttpPost]
    [MustHavePermission(ScreenDraftsAction.Create, ScreenDraftsResource.Roles)]
    ...
    [HttpDelete("{id}")]
    [MustHavePermission(ScreenDraftsAction.Delete, ScreenDraftsResource.Roles)]
