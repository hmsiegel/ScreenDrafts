...
export interface IClient {
     ...
     * @return No Content
     */
    guestDrafts_UpdateGuestDraft(body: UpdateGuestDraftRequest): Promise<void>;

    /**
     * @return OK
     */
    guestDrafts_GetGameplay(body: GetGuestDraftGameplayRequest): Promise<GetGuestDraftGameplayResponse>;
     ...
     * @return No Content
     */
    guestDrafts_AssignParticipantToPosition(body: AssignParticipantToPositionRequest): Promise<void>;

    /**
     * @return No Content
     */
    guestDrafts_UndoVeto(body: UndoGuestDraftVetoRequest): Promise<void>;

    /**
     * @return No Content
     */
    guestDrafts_UndoPick(body: UndoGuestDraftPickRequest): Promise<void>;

    /**
     * @return No Content
     */
    guestDrafts_RevealPick(body: RevealGuestDraftPickRequest): Promise<void>;

    /**
     * @return No Content
     */
    guestDrafts_PlayPick(body: PlayGuestDraftPickRequest): Promise<void>;

    /**
     * @return No Content
     */
    guestDrafts_ApplyVeto(body: ApplyGuestDraftVetoRequest): Promise<void>;

    /**
     * @return No Content
     */
    guestDrafts_ApplyVetoOverride(body: ApplyGuestDraftVetoOverrideRequest): Promise<void>;
     ...
     * @return OK
     */
    guestDrafts_GetDetails(body: GetGuestDraftDetailsRequest): Promise<GuestDraftDetailResponse>;

    /**
     * @return Created
     */
    guestDrafts_CreateGuestDraft(body: CreateGuestDraftRequest): Promise<CreatedResponse>;

    /**
     * @return No Content
     */
    guestDrafts_AddParticipant(body: AddParticipantRequest): Promise<void>;

    /**
     * @return OK
     */
    guestDrafters_Search(body: SearchGuestDraftersRequest): Promise<GuestDrafterSummaryResponse[]>;
...
export class Client implements IClient {
     ...
     * @return No Content
     */
    guestDrafts_UpdateGuestDraft(body: UpdateGuestDraftRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_UpdateGuestDraft(_response);
        });
    }

    protected processGuestDrafts_UpdateGuestDraft(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    guestDrafts_GetGameplay(body: GetGuestDraftGameplayRequest, signal?: AbortSignal): Promise<GetGuestDraftGameplayResponse> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_GetGameplay(_response);
        });
    }

    protected processGuestDrafts_GetGameplay(response: Response): Promise<GetGuestDraftGameplayResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as GetGuestDraftGameplayResponse;
            return result200;
            });
        } else if (status === 403) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetGuestDraftGameplayResponse>(null as any);
    }

    /**
     * @return OK
     */
    guestDrafts_SetStatus(body: SetGuestDraftStatusRequest, signal?: AbortSignal): Promise<SetGuestDraftStatusResponse> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/status";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_SetStatus(_response);
        });
    }

    protected processGuestDrafts_SetStatus(response: Response): Promise<SetGuestDraftStatusResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as SetGuestDraftStatusResponse;
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SetGuestDraftStatusResponse>(null as any);
    }
    ...
    guestDrafts_Search(body: SearchGuestDraftsRequest, signal?: AbortSignal): Promise<PagedResultOfGuestDraftSummaryResponse> {
        let url_ = this.baseUrl + "/guest-drafts/search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_Search(_response);
        });
    }

    protected processGuestDrafts_Search(response: Response): Promise<PagedResultOfGuestDraftSummaryResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as PagedResultOfGuestDraftSummaryResponse;
            return result200;
            });
        } else if (status === 403) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagedResultOfGuestDraftSummaryResponse>(null as any);
    }

    /**
     * @return No Content
     */
    guestDrafts_AssignParticipantToPosition(body: AssignParticipantToPositionRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/positions/{positionPublicId}/assign";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_AssignParticipantToPosition(_response);
        });
    }

    protected processGuestDrafts_AssignParticipantToPosition(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return No Content
     */
    guestDrafts_UndoVeto(body: UndoGuestDraftVetoRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/picks/{playOrder}/undo-veto";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_UndoVeto(_response);
        });
    }

    protected processGuestDrafts_UndoVeto(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return No Content
     */
    guestDrafts_UndoPick(body: UndoGuestDraftPickRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/picks/{playOrder}";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_UndoPick(_response);
        });
    }

    protected processGuestDrafts_UndoPick(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return No Content
     */
    guestDrafts_RevealPick(body: RevealGuestDraftPickRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/picks/{playOrder}/reveal";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_RevealPick(_response);
        });
    }

    protected processGuestDrafts_RevealPick(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return No Content
     */
    guestDrafts_PlayPick(body: PlayGuestDraftPickRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/picks";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_PlayPick(_response);
        });
    }

    protected processGuestDrafts_PlayPick(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return No Content
     */
    guestDrafts_ApplyVeto(body: ApplyGuestDraftVetoRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/picks/{playOrder}/veto";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_ApplyVeto(_response);
        });
    }

    protected processGuestDrafts_ApplyVeto(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return No Content
     */
    guestDrafts_ApplyVetoOverride(body: ApplyGuestDraftVetoOverrideRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/picks/{playOrder}/veto-override";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_ApplyVetoOverride(_response);
        });
    }

    protected processGuestDrafts_ApplyVetoOverride(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return No Content
     */
    guestDrafts_ApplyCommissionerOverride(body: ApplyGuestDraftCommissionerOverrideRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/picks/{playOrder}/commissioner-override";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_ApplyCommissionerOverride(_response);
        });
    }

    protected processGuestDrafts_ApplyCommissionerOverride(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    guestDrafts_GetDetails(body: GetGuestDraftDetailsRequest, signal?: AbortSignal): Promise<GuestDraftDetailResponse> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/summary";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_GetDetails(_response);
        });
    }

    protected processGuestDrafts_GetDetails(response: Response): Promise<GuestDraftDetailResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as GuestDraftDetailResponse;
            return result200;
            });
        } else if (status === 403) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GuestDraftDetailResponse>(null as any);
    }

    /**
     * @return Created
     */
    guestDrafts_CreateGuestDraft(body: CreateGuestDraftRequest, signal?: AbortSignal): Promise<CreatedResponse> {
        let url_ = this.baseUrl + "/guest-drafts";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_CreateGuestDraft(_response);
        });
    }

    protected processGuestDrafts_CreateGuestDraft(response: Response): Promise<CreatedResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
     ...
     * @return No Content
     */
    guestDrafts_AddParticipant(body: AddParticipantRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/guest-drafts/{publicId}/participants";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafts_AddParticipant(_response);
        });
    }

    protected processGuestDrafts_AddParticipant(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    guestDrafters_Search(body: SearchGuestDraftersRequest, signal?: AbortSignal): Promise<GuestDrafterSummaryResponse[]> {
        let url_ = this.baseUrl + "/guest-drafters/search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGuestDrafters_Search(_response);
        });
    }

    protected processGuestDrafters_Search(response: Response): Promise<GuestDrafterSummaryResponse[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as GuestDrafterSummaryResponse[];
            return result200;
            });
        } else if (status === 403) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GuestDrafterSummaryResponse[]>(null as any);
    }
...
export interface ApplyGuestDraftCommissionerOverrideRequest {
    publicId?: string;
    playOrder?: number;
...
export interface ApplyGuestDraftVetoOverrideRequest {
    publicId?: string;
    playOrder?: number;
...
export interface ApplyGuestDraftVetoRequest {
    publicId?: string;
    playOrder?: number;
    note?: string | undefined;
...
export interface AssignParticipantToPositionRequest {
    publicId?: string;
...
export interface GetGuestDraftDetailsRequest {
    publicId?: string;

    [key: string]: any;
}

export interface GetGuestDraftGameplayRequest {
    publicId?: string;

    [key: string]: any;
}

export interface GetGuestDraftGameplayResponse {
...
export interface GuestDraftDetailPickResponse {
    position?: number;
    moviePublicId?: string | undefined;
    movieTitle?: string | undefined;
    movieYear?: string | undefined;
    tmdbId?: number | undefined;
    playedByDisplayName?: string | undefined;
    wasVetoed?: boolean;
    wasVetoOverridden?: boolean;
    wasCommissionerOverride?: boolean;
    isActiveOnFinalBoard?: boolean;
    vetoedByDisplayName?: string | undefined;
    savedByDisplayName?: string | undefined;

    [key: string]: any;
}

export interface GuestDraftDetailPositionResponse {
    name: string;
    picks?: number[];
    assignedParticipantDisplayName?: string | undefined;

    [key: string]: any;
}

export interface GuestDraftDetailResponse {
    publicId: string;
    title: string;
    type: string;
    status: string;
...
export interface GuestDrafterSummaryResponse {
    publicId: string;
    displayName: string;
...
export interface GuestDraftGameplayParticipantResponse {
    participantId?: string;
    ...
    overrideTokensRemaining?: number;
    fungibleTokensRemaining?: number;
    commissionerOverridesUsed?: number;

    [key: string]: any;
}

export interface GuestDraftGameplayPickResponse {
    playOrder?: number;
    position?: number;
    moviePublicId?: string | undefined;
    movieTitle?: string | undefined;
    ...
    vetoSequence?: number;
    revealAuthorizedParticipantId?: string | undefined;
    revealAuthorizedByDisplayName?: string | undefined;
    vetoHistory?: GuestDraftGameplayVetoHistoryEntryResponse[];

    [key: string]: any;
}

export interface GuestDraftGameplayPositionResponse {
    positionPublicId?: string;
    name?: string;
    picks?: number[];
    hasBonusVeto?: boolean;
...
export interface GuestDraftGameplayVetoHistoryEntryResponse {
    sequence?: number;
    vetoedByDisplayName?: string;
    wasVetoFungible?: boolean;
    isOverridden?: boolean;
...
export interface GuestDraftSummaryResponse {
    publicId: string;
    title: string;
    type: string;
    status: string;
...
export interface PagedResultOfGuestDraftSummaryResponse {
    items: GuestDraftSummaryResponse[];
    totalCount: number;
    page: number;
    pageSize: number;
    totalPages?: number;
...
export interface PlayGuestDraftPickRequest {
    publicId?: string;
    moviePublicId: string;
    position: number;
    playOrder: number;
...
export interface RevealGuestDraftPickRequest {
    publicId?: string;
    playOrder?: number;
...
export interface SearchGuestDraftersRequest {
    search?: string | undefined;

    [key: string]: any;
}

export interface SearchGuestDraftsRequest {
    page?: number;
    pageSize?: number;
...
export interface SetGuestDraftStatusRequest {
    publicId?: string;
    action?: number;
...
export interface SetGuestDraftStatusResponse {
    guestDraftPublicId?: string;
    status?: string;
...
export interface UndoGuestDraftPickRequest {
    publicId?: string;
    playOrder?: number;
...
export interface UndoGuestDraftVetoRequest {
    publicId?: string;
    playOrder?: number;
