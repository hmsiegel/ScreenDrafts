...
import { CommunityConfig, CommunitySection, defaultCommunityConfig } from "../../new/community-section";
import { defaultPredictionConfig, PredictionConfig, PredictionRulesSection } from "../../new/prediction-rules-section";
import { getDefaultPositions, isFixedPositionType, PositionConfig, PositionsEditor } from "../../new/positions-editor";
import { ParticipantsSection } from "../../new/participants-section";
          ...
          {parts.map((part, idx) => (
            <div key={idx}>
              ...
              <CommunitySection
                ...
                onChange={(next: any) => updatePartCommunityConfig(idx, next)}
              />
            </div>
          ))}
        </div>
          ...
          {parts.map((part, idx) => (
            <div key={idx}>
              ...
              <PredictionRulesSection
                ...
                onChange={(next: PredictionConfig) => updatePartPredictionConfig(idx, next)}
                accessToken={accessToken}
              />
            </div>
          ))}
