...
using ScreenDrafts.Infrastructure.Auth.Jwt;
...
internal class TokenService : ITokenService
{
    ...
    private IEnumerable<Claim> GetClaims(ApplicationUser user, string ipAddress) =>
        new List<Claim>
        {
            ...
            new(ScreenDraftsClaims.Fullname, $"{user.FirstName} {user.LastName}"),
            new(ClaimTypes.Name, user.FirstName ?? string.Empty),
            new(ClaimTypes.Surname, user.LastName ?? string.Empty),
            new(ScreenDraftsClaims.IpAddress, ipAddress),
            new(ScreenDraftsClaims.Tenant, _currentTenant!.Id),
            new(ScreenDraftsClaims.ImageUrl, user.ImageUrl ?? string.Empty),
